...
kbase_dma_fence_queue_work(struct kbase_jd_atom *katom)
{
	...
	katom->run_status |= kRunOn_DmaFenceQueueWork;
	katom->dma_fence_work.execute_num++;
...
kbase_dma_fence_work(struct work_struct *pwork)
{
	...
	ctx = &katom->kctx->jctx;
	katom->run_status |= kRunOn_DmaFenceWork;
	katom->dma_fence_work.execute_num--;
	katom->dma_fence_work.done_work_time = ktime_get();
	katom->dma_fence_work.work_time_spent = katom->dma_fence_work.done_work_time -
											katom->dma_fence_work.queue_work_time;
...
#endif
{
	...
	katom->run_status |= kRunOn_DmaFenceCb;
